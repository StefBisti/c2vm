...
SRCS := c2vm.c src/run.c src/cleanup.c src/build.c src/ova.c src/boottest.c src/json.c src/scan.c
OBJS := $(SRCS:.c=.o)
LDLIBS ?= -lcrypt
...
$(OBJS): src/run.h src/cleanup.h src/build.h src/ova.h src/boottest.h src/json.h src/scan.h
